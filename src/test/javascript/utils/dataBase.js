...
exports.oracle = {
    libpath: __dirname+'/src/test/resources/DBDrivers/oracle/ojdbc7.jar',
  ...
  exports.mysql = {
    libpath: __dirname+'/src/test/resources/DBDrivers/mysql/mysql-connector-java-5.0.8-bin.jar',
