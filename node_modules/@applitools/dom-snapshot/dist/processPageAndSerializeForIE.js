            ...
            */
            ...
            function makeProcessResource(_ref) {
              var fetchUrl = _ref.fetchUrl,
                  ...
                  _ref$logTimestamp = _ref.logTimestamp,
                  logTimestamp = _ref$logTimestamp === void 0 ? noop : _ref$logTimestamp;
              return function processResource(_ref2) {
                ...
                if (!cache[url]) {
                  if (sessionCache.getItem(url)) {
                    var resourceUrls = getDependencies(url);
                    logTimestamp('doProcessResource from sessionStorage', url, 'deps:', resourceUrls.slice(1));
                    ...
                    cache[url] = doProcessResource(url).then(function (result) {
                      logTimestamp('doProcessResource', "[".concat(Date.now() - now, "ms]"), url);
                      return result;
                    });
                  }
                }
                ...
                function doProcessResource(url) {
                  ...
                  return fetchUrl(url).catch(function (e) {
                    ...
                    if (probablyCORS) {
                      sessionCache.setItem(url, []);
                      return {
                        resourceUrls: [url]
                      };
                    }

                    logTimestamp('fetched', "[".concat(Date.now() - now, "ms]"), url);
                    ...
                    if (dependentUrls) {
                      ...
                      sessionCache.setItem(url, absoluteDependentUrls);
                    ...
                    logTimestamp('error while fetching', url, err);
                ...
                function clearFromSessionStorage() {
                  logTimestamp('clearing from sessionStorage:', url);
                  ...
                  logTimestamp('cleared from sessionStorage:', url);
                }
              };
            }
            ...
            function processPage() {
              ...
              var logTimestamp$$1 = debug ? logTimestamp(Date.now()) : noop;
              logTimestamp$$1('processPage start');
              var sessionCache$$1 = sessionCache({
                log: logTimestamp$$1
              });
              var styleSheetCache = {};
