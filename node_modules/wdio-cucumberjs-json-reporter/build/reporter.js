...
class CucumberJsJsonReporter extends _reporter.default {
  ...
  onRunnerEnd() {
    ...
    const jsonFile = (0, _path.resolve)(jsonFolder, `${this.feature.id}.${new Date().getTime()}.json`);
  ...
  getStepDataObject(stepData) {
    const keyword = stepData.keyword || (stepData.title.match(/^(Given|When|Then|And|After|Before)\s/) || []).pop() || '';
