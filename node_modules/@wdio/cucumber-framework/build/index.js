...
class CucumberAdapter {
  ...
  addWdioHooks(config) {
    Cucumber.Before(function wdioHookBeforeScenario({
      ...
      return (0, _config.executeHooksWithArgs)(config.beforeScenario, [uri, feature, pickle, sourceLocation]);
    });
    Cucumber.After(function wdioHookAfterScenario({
      ...
      return (0, _config.executeHooksWithArgs)(config.afterScenario, [uri, feature, pickle, result, sourceLocation]);
    });
    Cucumber.BeforeAll(function wdioHookBeforeFeature() {
      ...
      return (0, _config.executeHooksWithArgs)(config.beforeFeature, [uri, feature, scenarios]);
    });
    Cucumber.AfterAll(function wdioHookAfterFeature() {
      ...
      return (0, _config.executeHooksWithArgs)(config.afterFeature, [uri, feature, scenarios]);
    });
  }
  ...
  wrapStep(code, retryTest = 0, isStep, config, cid) {
    const executeFn = (0, _utils.isFunctionAsync)(code) || !_config.hasWdioSyncSupport ? _config.executeAsync : _config.executeSync;
    return function (...args) {
      const before = isStep ? config.beforeStep : config.beforeHook;
      const after = isStep ? config.afterStep : config.afterHook;
      return executeFn.call(this, (0, _utils2.wrapWithHooks)(isStep ? 'Step' : 'Hook', code, before, after, cid), retryTest, args);
    };
  }
